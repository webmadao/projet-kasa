...
function About() {
  return (
    <>
      <Banner className='aboutBanner' image="./images/montagnes.png" />
      ...
      <Collapse 
        ...
        <Collapse 
          ...
          locataire, cela permet à nos équpes de vérifier que les standards sont bien respectés. Nous organisons également des ateliers sur la sécurité domestique pour nos hôtes."
        />
      </div>
    </>
  );
